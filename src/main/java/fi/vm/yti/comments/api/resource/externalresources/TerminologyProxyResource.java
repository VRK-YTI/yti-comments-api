        ...
        if (response.getStatusCode() == HttpStatus.OK && response.getBody() != null) {
            try {
                ...
                if (data != null) {
                    ...
                    throw new YtiCommentsException(new ErrorModel(HttpStatus.NOT_ACCEPTABLE.value(), "Invalid data from terminology containers integration API."));
                }
        ...
        if (response.getStatusCode() == HttpStatus.OK && response.getBody() != null) {
            try {
                ...
                if (data != null) {
                    ...
                    throw new YtiCommentsException(new ErrorModel(HttpStatus.NOT_ACCEPTABLE.value(), "Invalid data from terminology resources integration API."));
                }
            } catch (final IOException e) {
